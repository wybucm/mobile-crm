  ...
  :style="containerStyle">
    <div id="calendar" v-show="changeShowCalendar">
      ...
      <!--<label for="calendar-input">
        <input ref="mainInput" class="calendar-input" type="text" readonly="readonly" v-model="selectValue">
    </label>-->
  </div>      
</template>
...
export default {
  ...
  computed: {
    ...
    selectValue: function () {
      return `${this.trueSelectMonth}/${this.trueSelectDay}/${this.trueSelectYear}`;
    },
